package life.happyholiday.utils.auth;

/*
 * Auth class copy from Realm library
 *
 * Created by liuyang on 10/19/2017.
 */
...
public abstract class GoogleAuth implements GoogleApiClient.OnConnectionFailedListener {
    ...
    public GoogleAuth(final SignInButton btnSignIn, final FragmentActivity fragmentActivity) {
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestEmail()
                .requestIdToken("466792304789-pb73c426ttkju77t014td68pl1ghd97h.apps.googleusercontent.com")
                .build();
